...
/-! ## End-to-end theorem: ODE + r persistence → r → r*
...
Hypothesis budget:
  • ODE data: existence, self-consistency, (0,1)-invariance, continuity
  • Equilibrium: α_star, r_star, equilibrium equation
  • γ ≥ 0 with ∫γ > 0 and γ integrable (finite first moment)
  • r persistence: r(t) ≥ r_min > 0 (from instability escape / Ψ-growth)
  • α₀ body lower bound: ∀ M > 0, inf_{γ ≤ M} α₀ > 0
    (automatic for continuous α₀ on compact body [-M,M])
