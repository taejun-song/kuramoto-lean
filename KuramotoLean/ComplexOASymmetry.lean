...
theorem complex_oa_symmetry_preserved [IsProbabilityMeasure μ]
  ...
  -- The proof requires:
  -- 1. Define w(ω,t) = conj(z(neg ω, t))
  -- 2. Show w satisfies the same ODE as z (using symmetry of g and η real)
  -- 3. Apply ODE uniqueness (Picard-Lindelöf)
  -- The Lipschitz bound for the complex OA RHS and the uniqueness
  -- application require connecting to Mathlib's ODE.PicardLindelof.
  sorry
